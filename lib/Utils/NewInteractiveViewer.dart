...
/// {@end-tool}
@immutable
class NewInteractiveViewer extends StatefulWidget {
  ...
  static Vector3 getNearestPointInside(Vector3 point, Quad quad) {
    ...
    final List<Vector3> closestPoints = <Vector3>[
      NewInteractiveViewer.getNearestPointOnLine(point, quad.point0, quad.point1),
      NewInteractiveViewer.getNearestPointOnLine(point, quad.point1, quad.point2),
      NewInteractiveViewer.getNearestPointOnLine(point, quad.point2, quad.point3),
      NewInteractiveViewer.getNearestPointOnLine(point, quad.point3, quad.point0),
    ];
  ...
  @override NewInteractiveViewerState createState() => NewInteractiveViewerState();
}

class NewInteractiveViewerState extends State<NewInteractiveViewer> with TickerProviderStateMixin {
  TransformationController _transformationController;
  ...
  @override
  void didUpdateWidget(NewInteractiveViewer oldWidget) {
...
/// See also:
///
///  * [NewInteractiveViewer.transformationController] for detailed documentation
...
Quad _getAxisAlignedBoundingBoxWithRotation(Rect rect, double rotation) {
  ...
  return NewInteractiveViewer.getAxisAlignedBoundingBox(boundariesRotated);
}
...
Offset _exceedsBy(Quad boundary, Quad viewport) {
  ...
  for (final Vector3 point in viewportPoints) {
    final Vector3 pointInside = NewInteractiveViewer.getNearestPointInside(point, boundary);
